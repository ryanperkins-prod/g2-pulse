                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-6">
                  <div className="flex items-start space-x-2">
                    ...
                    <div className="text-sm">
                      <span className="font-semibold text-gray-900">Review Incentive Structure:</span>
                      <span className="text-gray-700 ml-1">Rewards are distributed in $25 increments ($25, $50, $75, or $100) based on review completion.</span>
                    </div>
                  </div>
                </div>
